...
def train(trainImages, trainGTs):
...
duration = end - start
print("Trained: {:.3f}".format(duration))
# np.save('./results/data.txt', data)
...
duration = end - start
print("Tested: {:.3f}".format(duration))

# print ('predictMask', predictMask.shape)
...
calcAccuracy2(U, predictMask)

np.save('./results/knnMask-1', predictMask)
...
#             edgecolor='None', s=20, label="skin")
# plt.xlim(xx.min(), xx.max())
# plt.ylim(yy.min(), yy.max())
# plt.xlabel('Cb')
# plt.ylabel('Cr')
# plt.legend()
# plt.title("K-nn (k = 3, weights = distance)")
# print('saving figure')
# plt.savefig('./results/knn-3.png')
# plt.show()
# print('Finished')
